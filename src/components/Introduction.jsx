            ...
            <Container ref={introRef} fluid>
                <Row className='details' id='details'>
                    ...
                    <Col className='d-flex justify-content-between flex-row '>
                        <div className='mr w-100'><p>As a junior web developer, it is really important for me to seize every opportunity to develop my skills and also myself, so I am constantly working on something. During university, I gained different kinds of work experiences, and improved my visual, aesthetic and design skill set. As part of Codecool, I learned the basics of coding. Now I am confidently using different graphic design softwares for supporting my work as a front end developer. My different kinds of experiences have prepared me to work with different people with different professional backgrounds and understand my role in a complex work environment.</p></div>
